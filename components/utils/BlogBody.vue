<template>
  <v-container grid-list-md >
    <v-layout row wrap pa-2>
      ...
      <v-flex xs12 sm12 md12 v-if="blog.imagesList.length > 0">
        <ImageListView :images="blog.imagesList"></ImageListView>
      </v-flex>
...
export default {
  ...
  computed: {
    timeOfReview() {
      return TImeUtil.timeDifference(this.blog.timestamp, this.blog.time);
    }
  },
  /**
